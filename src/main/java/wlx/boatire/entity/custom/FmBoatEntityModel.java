...
public class FmBoatEntityModel extends CompositeEntityModel<FmBoatEntity> implements ModelWithWaterPatch {
    /**
    ...
    public FmBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(FmBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(FmBoatEntity entity, int sigma, ModelPart part, float angle) {
